...
router.get('/userList', adminMiddleware, controllerAdmin.userList) // Renderizado de listado de usuarios
router.get("/buscarUsuario", controllerAdmin.buscarUsuario); // Busca usuarios dentro del listado
router.delete('/eliminarUsuario/:id', adminMiddleware, controllerAdmin.userDelete) // Proceso de eliminacion de usuario
