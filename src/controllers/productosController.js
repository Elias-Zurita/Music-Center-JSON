...
function findAll() {
  ...
  ); // Lee el archivo products.json donde estan los productos
...
module.exports = {
  ...
  categoria: (req, res) => {
    let productos = findAll();
    let categoriaSeleccionada = productos.filter(function (productos) {
      // filtra las categorias de los productos
